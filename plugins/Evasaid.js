...
if (conf.LANG == 'TR') {
    ...
    already_on = 'Ruby yapay zekası halihazırda tüm fonksiyonları etkin.'
    already_off = 'Ruby yapay zekası halihazırda yarı fonksiyonel çalışıyor.'
    succ_on = 'Ruby, Tam Fonksiyonel Olarak Açıldı! Lütfen Biraz Bekleyin! ✅'
    succ_off = 'Ruby, Yarı Fonksiyonel Olarak Ayarlandı! Lütfen Biraz Bekleyin! ☑️'
}
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional Pinky features. Turn your account into a ai chatbot!'
    already_on = 'Ruby artificial intelligence is already fully functional.'
    already_off = 'Ruby artificial intelligence is currently running semi-functional.'
    succ_on = 'Ruby Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'Ruby Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'ML') {
